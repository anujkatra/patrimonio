  ...
  const res = await fetch(
    `https://api.mailgun.net/v3/${mailgunDomain}/messages`,
    {
      ...
      body: new URLSearchParams({
        ...
        html:`<html><p>A new ${_type === 'paintingForm'?'painting':'contact'} inquiry was recieved.</p><br /><p><a href='https://patrimonio-sanity-git-anujk-add-e-e1d8a8-yashbajaj234s-projects.vercel.app/structure/${_type};${_id}'>Link</a></p></html>`,
      }),
    }
  )
