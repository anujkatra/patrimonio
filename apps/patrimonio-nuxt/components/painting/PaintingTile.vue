...
<template>
  <div
    :class="
      twMerge(
        `group flex w-full max-w-[300px] flex-col md:max-w-[350px] lg:h-[435px] lg:gap-5 lg:pb-5`,
        props.class,
      )
    "
  >
    ...
    <div
      class="flex max-h-fit w-full flex-col gap-[5px] p-5 transition-all duration-500 lg:h-[80px] lg:overflow-hidden lg:group-hover:h-full lg:group-hover:overflow-visible lg:group-hover:bg-[linear-gradient(264.83deg,rgba(252,251,247,0.25)_-4.61%,rgba(129,178,219,0.25)_44.28%,rgba(214,51,46,0.25)_112.37%)]"
    >
